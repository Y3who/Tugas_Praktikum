...
if karakter == 1 :
    kalimat_2 = ("Ibnu sedang ngopi ")
if karakter == 2 :
    kalimat_2 = ("Ibnu sedang makan ")
if karakter == 3 :
    kalimat_2 = ("Ibnu sedang menonton acara olahraga ")
...
if usia == 2 :
    kalimat_7 = ("karena usianya sudah 73 tahun ")
if usia == 3 :
    kalimat_7 = ("karena usianya sudah 71 tahun ")
